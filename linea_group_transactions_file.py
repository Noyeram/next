...
groups_df = pd.read_csv("D:/sybil/linea_txlist_address_groups.csv")
...
def get_transactions_from_file(address):
    ...
    filepath = f"D:/sybil/linea_txlists/{address}_txlist.csv"
...
output_file_path = "D:/sybil/linea_group_transactions.csv"
