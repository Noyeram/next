...
groups_df = pd.read_csv("D:/sybil/boba_txlist_address_groups.csv")
...
def get_transactions_from_file(address):
    ...
    filepath = f"D:/sybil/boba_txlists/{address}_txlist.csv"
...
output_file_path = "D:/sybil/boba_group_transactions.csv"
