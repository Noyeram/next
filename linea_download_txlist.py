...
LINEASCAN_API_URL = "https://api.lineascan.build/api"
...
def fetch_txlist_and_save(address, api_key):
    ...
    while True:
        time.sleep(0.8)
        response = requests.get(LINEASCAN_API_URL, params=params)
...
output_directory = "D:\\sybil\\linea_txlists"
...
fetch_all_addresses_and_save_txlist(addresses_to_process, API_KEYS_LINEA, output_directory)
...
valid_addresses_df.to_csv(r"D:\sybil\linea_valid_addresses.csv", index=False)
