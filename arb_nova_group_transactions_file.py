...
groups_df = pd.read_csv("D:/sybil/arb_nova_txlist_address_groups.csv")
...
def get_transactions_from_file(address):
    ...
    filepath = f"D:/sybil/arb_nova_txlists/{address}_txlist.csv"
...
output_file_path = "D:/sybil/arb_nova_group_transactions.csv"
