...
groups_df = pd.read_csv("D:/sybil/polygon_zkevm_txlist_address_groups.csv")
...
def get_transactions_from_file(address):
    ...
    filepath = f"D:/sybil/polygon_zkevm_txlists/{address}_txlist.csv"
    ...
    for address in addresses:
        ...
        for tx in transactions:
            ...
            if tx["from"] in addresses and tx["to"] in addresses and tx["from"] != tx["to"] and tx["input"] == "0x" and tx["value"] != 0:
                ...
                transfer_data = {"GROUP": index, "hash": tx["hash"], "from": tx["from"], "to": tx["to"], "tokenSymbol": "ETH", "value": value}
...
output_file_path = "D:/sybil/polygon_zkevm_group_transactions.csv"
