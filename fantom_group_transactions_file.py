...
groups_df = pd.read_csv("D:/sybil/fantom_txlist_address_groups.csv")
...
def get_transactions_from_file(address):
    ...
    filepath = f"D:/sybil/fantom_txlists/{address}_txlist.csv"
    ...
    for address in addresses:
        ...
        for tx in transactions:
            ...
            if tx["from"] in addresses and tx["to"] in addresses and tx["from"] != tx["to"] and tx["input"] == "0x" and tx["value"] != 0:
                ...
                transfer_data = {"GROUP": index, "hash": tx["hash"], "from": tx["from"], "to": tx["to"], "tokenSymbol": "FTM", "value": value}
...
output_file_path = "D:/sybil/fantom_group_transactions.csv"
