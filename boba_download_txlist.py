...
BOBASCAN_API_URL = "https://api.bobascan.com/api"
...
def fetch_txlist_and_save(address, api_key):
    ...
    while True:
        time.sleep(0.5)
        response = requests.get(BOBASCAN_API_URL, params=params)
...
output_directory = "D:\\sybil\\boba_txlists"
...
fetch_all_addresses_and_save_txlist(addresses_to_process, API_KEYS_BOBA, output_directory)
...
valid_addresses_df.to_csv(r"D:\sybil\boba_valid_addresses.csv", index=False)
