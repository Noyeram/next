...
FTMSCAN_API_URL = "https://api.ftmscan.com/api"
...
def fetch_txlist_and_save(address, api_key):
    ...
    while True:
        time.sleep(0.5)
        response = requests.get(FTMSCAN_API_URL, params=params)
...
output_directory = "D:\\sybil\\fantom_txlists"
...
fetch_all_addresses_and_save_txlist(addresses_to_process, API_KEYS_FTM, output_directory)
...
valid_addresses_df.to_csv(r"D:\sybil\fantom_valid_addresses.csv", index=False)
